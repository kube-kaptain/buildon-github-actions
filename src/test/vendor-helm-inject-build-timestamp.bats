...
#
# Tests for main/vendor-helm-inject-build-timestamp

load helpers

SCRIPT="$SCRIPTS_DIR/vendor-helm-inject-build-timestamp"

setup() {
  TEST_DIR=$(create_test_dir "vendor-helm-inject-bts")
...
@test "stamps kaptain.org/build-timestamp into every yaml under combined/" {
