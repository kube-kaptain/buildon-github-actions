...
@test "generates valid ServiceAccount structure" {
  ...
  [[ "$manifest" == *"kind: ServiceAccount"* ]] || return 1
...
@test "includes kaptain annotations" {
  ...
  [[ "$manifest" == *'kaptain.org/generated-by: "Generated by Kaptain generate-kubernetes-serviceaccount"'* ]] || return 1
...
@test "adds serviceaccount-specific additional labels" {
  ...
  manifest=$(read_manifest)
  [[ "$manifest" == *"sa-label: value"* ]] || return 1
}
...
@test "adds serviceaccount-specific additional annotations" {
  ...
  manifest=$(read_manifest)
  [[ "$manifest" == *"iam.gke.io/gcp-service-account: my-sa@project.iam.gserviceaccount.com"* ]] || return 1
}
