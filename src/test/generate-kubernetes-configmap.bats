...
@test "includes kaptain annotations" {
  ...
  assert_contains "$manifest" 'kaptain.org/generated-by: "Generated by Kaptain generate-kubernetes-configmap"'
...
@test "additional annotations can override builtin annotations" {
  create_config_file "app.properties" "key=value"
  export KUBERNETES_CONFIGMAP_ADDITIONAL_ANNOTATIONS='kaptain.org/generated-by="custom generator"'
...
@test "checksum-named ConfigMap omits volatile metadata, keeps stable identity" {
  create_config_file "app.properties" "key=value"
  ...
  manifest=$(read_manifest)
  # Volatile keys must be absent: they churn the content checksum per build
  ...
  assert_contains "$manifest" 'app: "${ProjectName}-configmap-checksum"'
  assert_contains "$manifest" 'app.kubernetes.io/managed-by: "Kaptain"'
  assert_contains "$manifest" 'kaptain.org/project-name: "${ProjectName}"'
  assert_contains "$manifest" 'kaptain.org/generated-by: "Generated by Kaptain generate-kubernetes-configmap"'
  assert_contains "$manifest" 'kaptain.org/built-by: "test"'
