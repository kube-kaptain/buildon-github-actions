...
generate_metadata() {
  ...
  case "${type}" in
    labels)
      ...
      builtin="${builtin},kaptain.org/version=\"${version_token}\",kaptain.org/project-name=${project_name_token}"
      builtin="${builtin},kaptain.org/environment=\"${environment_token}\""
      ...
      ;;
    annotations)
      builtin="kaptain.org/project-name=${project_name_token},kaptain.org/version=\"${version_token}\",kaptain.org/build-timestamp=\"${build_timestamp}\",kaptain.org/generated-by=\"Generated by Kaptain ${script_name}\""
