...
KUBERNETES_SERVICE_ADDITIONAL_LABELS="${KUBERNETES_SERVICE_ADDITIONAL_LABELS:-}"
KUBERNETES_SERVICE_ADDITIONAL_ANNOTATIONS="${KUBERNETES_SERVICE_ADDITIONAL_ANNOTATIONS:-}"
