...
# Required acknowledgment to use Parallel (must be I_LIKE_DOWNTIME)
KUBERNETES_STATEFULSET_ALLOW_UNRELIABLE_POD_MANAGEMENT_POLICY="${KUBERNETES_STATEFULSET_ALLOW_UNRELIABLE_POD_MANAGEMENT_POLICY:-}"
...
ALLOW_UNRELIABLE_POD_MANAGEMENT_POLICY="${KUBERNETES_STATEFULSET_ALLOW_UNRELIABLE_POD_MANAGEMENT_POLICY}"
