...
# Per-platform directories for multi-platform builds
...
DOCKER_CONTEXT_SUB_PATH_LINUX_AMD64="${DOCKER_CONTEXT_SUB_PATH_LINUX_AMD64:-${OUTPUT_SUB_PATH}/docker-linux-amd64/substituted}"
DOCKER_CONTEXT_SUB_PATH_LINUX_ARM64="${DOCKER_CONTEXT_SUB_PATH_LINUX_ARM64:-${OUTPUT_SUB_PATH}/docker-linux-arm64/substituted}"
