...
# Min ready seconds before pod considered available
KUBERNETES_DAEMONSET_MIN_READY_SECONDS="${KUBERNETES_DAEMONSET_MIN_READY_SECONDS:-0}"
...
MIN_READY_SECONDS="${KUBERNETES_DAEMONSET_MIN_READY_SECONDS}"
